...
- `default` read/search/list preapproval applies only after sensitive-path checks pass; sensitive direct reads and broad directory traversals fall through to confirmation, while protected-path hard blocks apply to bash/write/edit.
